...
export default function ReportSightingScreen() {
    ...
    const [guestContact, setGuestContact] = useState<string | undefined>(undefined)
    ...
    function combineDescriptors(animalType: string | null, sightingDescription: string | undefined, animalColor: string | undefined) {
    ...
    async function submitForm(
        ...
        try {
            ...
            const fullSightingDescription = combineDescriptors(animalType, sightingDescription, animalColor)
            ...
            const response = await fetch(`${process.env.EXPO_PUBLIC_API_URL}/sightings/`, {
                method: "POST",
                headers: {
            ...
            if (response.status === 201) {
                Alert.alert("Success!", "Your sighting report has been submitted successfully.")
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.topBar}>
                ...
                <Image style={styles.logo} source={require("../../../assets/images/logo.png")} testID="logo" />
            </View>
            ...
            <ScrollView>
                <View style={styles.sightingForm}>
                    <View style={styles.uploadImage}>
                        <Text style={styles.subtitle}>Please upload a photo of the sighting:</Text>
                        <Modal animationType="slide" transparent={true} visible={modal2Visible} onRequestClose={() => setModal2Visible(!modal2Visible)}>
                        ...
                        <TouchableOpacity style={styles.button} onPress={() => setModal2Visible(true)}>
                            <Image
                                source={selectedImage ? { uri: selectedImage } : require("../../../assets/images/add-pic.png")}
                                style={{ width: 200, height: 200 }}
                            />
                        </TouchableOpacity>
                        <Text style={styles.subtitle}>Please ensure you can clearly see the animal in your photo.</Text>
                    </View>
                    ...
                    <View style={styles.form}>
                            ...
                            <Modal animationType="slide" transparent={true} visible={modalVisible} onRequestClose={() => setModalVisible(!modalVisible)}>
                                <View style={styles.modalContainer}>
                                    <View style={styles.modalInner}>
                                        <Text style={styles.mapMessage}>Please select the location of the sighting on the map</Text>
                                        <View>
                                            <Text> MAP GOES HERE </Text>
                                        </View>
                                        <Pressable style={styles.button} onPress={() => setModalVisible(!modalVisible)}>
                                            <Text style={styles.buttonText}>Submit location and close map</Text>
                                        </Pressable>
                                    </View>
                                </View>
                            </Modal>
                        ...
                        <TextInput autoCapitalize="none" style={styles.input} placeholder="Please input color" onChangeText={setAnimalColor} />
                        ...
                        />
                        <Text style={styles.formLabels}>Your contact info (optional): </Text>
                        <TextInput placeholder="+44 1234567890" autoCapitalize="none" style={styles.input} onChangeText={setGuestContact} />
                    </View>

                    <TouchableOpacity
                        style={[styles.submitButton, submitting && { opacity: 0.6 }]}
                        onPress={() => submitForm(animalType, sightingDescription, animalColor, guestContact, location, selectedImage)}
                        disabled={submitting}
                    >
